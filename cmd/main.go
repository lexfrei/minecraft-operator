...
// +kubebuilder:rbac:groups=apiextensions.k8s.io,resources=customresourcedefinitions,verbs=get;list;patch,resourceNames=plugins.mc.k8s.lex.la;papermcservers.mc.k8s.lex.la
