...
// Valid indicates whether the value is a known member of the LabelSelectorRequirementOperator enum.
func (e LabelSelectorRequirementOperator) Valid() bool {
	switch e {
	case DoesNotExist:
		return true
	case Exists:
...
// Valid indicates whether the value is a known member of the PluginSourceType enum.
...
// Valid indicates whether the value is a known member of the UpdateStrategy enum.
func (e UpdateStrategy) Valid() bool {
	switch e {
	case Auto:
		return true
	case BuildPin:
