...
const (
	...
	// gcPortNameMinecraft is the name of the Minecraft game-traffic
	// service port / Gateway listener section (value coincides with
	// gcNamespaceMinecraft but is a distinct concept).
	gcPortNameMinecraft  = "minecraft"
