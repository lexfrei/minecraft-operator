...
var (
	...
	projectImage = "example.com/minecraft-operator:v0.0.1"
)
...
func TestE2E(t *testing.T) {
	...
	_, _ = fmt.Fprintf(GinkgoWriter, "Starting minecraft-operator integration test suite\n")
...
var _ = BeforeSuite(func() {
	...
	By("installing VolumeSnapshot CRDs for backup tests")
	snapshotCRDs := []string{
